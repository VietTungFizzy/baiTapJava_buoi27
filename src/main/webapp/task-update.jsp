            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-md-8 col-xs-12">
                        <div class="white-box">
                            <form action="task-change" method="POST" class="form-horizontal form-material">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <input name="nameTask" value="${task.nameTask}" type="text" placeholder="Tên công việc"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <input 
                                        	name="startTask" 
                                        	value="${task.startTask != null ? formatter.format(task.startTask) : null}" 
                                        	type="text" 
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <input 
                                        	type="text"
                                        	name="endTask"
                                        	value="${task.endTask != null ? formatter.format(task.endTask) : null}" 
                                        	placeholder="dd/MM/yyyy"
                                            class="form-control form-control-line"> 
                                    </div>
                                </div>
