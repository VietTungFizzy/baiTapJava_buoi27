                		...
                		<div class="col-md-4">
                			<div class="white-box">
	                            ...
	                            <div class="message-center">
	                            	<c:forEach var="task" items="${tasksGroupByStatus.get(status.id)}">
	                            		<a href="#">
		                                    <div class="mail-contnet">
		                                        <h5>${task.nameTask}</h5>
		                                        <span class="mail-desc"></span>
		                                        <span class="time">Bắt đầu: ${task.startTask != null ? formatter.format(task.startTask) : ""}</span>
		                                        <span class="time">Kết thúc: ${task.endTask != null ? formatter.format(task.endTask) : ""}</span>
		                                    </div>
		                                </a> 
	                            	</c:forEach>
	                            </div>
